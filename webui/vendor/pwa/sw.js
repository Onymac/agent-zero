...
importScripts('./workbox_sw_min@7.3.0.js');

// Define a global cache version variable. This should be updated on each deployment.
// Ideally, this would be automatically generated by a build tool based on file content hashes.
const CACHE_VERSION = '20250824030430'; // Using current datetime as a placeholder for a deployment-specific version
...
if (workbox) {
    ...
    workbox.core.setCacheNameDetails({
        prefix: 'agent-zero',
        suffix: 'v12' // New version number to trigger update
    });
    ...
    const CORE_STATIC_URLS = [
        ...
        { url: '/index.css', revision: CACHE_VERSION },
        { url: '/css/messages.css', revision: CACHE_VERSION },
        { url: '/css/toast.css', revision: CACHE_VERSION },
        { url: '/css/settings.css', revision: CACHE_VERSION },
        { url: '/css/notification.css', revision: CACHE_VERSION },
        { url: '/vendor/pwa/offline.html', revision: CACHE_VERSION },
        { url: '/vendor/pwa/manifest.json', revision: CACHE_VERSION }
    ];
    // NOTE: The 'revision' values now use the global CACHE_VERSION variable.
    // In a production environment, this CACHE_VERSION should still be automatically generated
    // by Workbox build tools (e.g., workbox-webpack-plugin) based on file content hashes
    // or a deployment-specific identifier, rather than manually updated.
    ...
    workbox.routing.setCatchHandler(async ({ event }) => {
        ...
        return caches.match('/vendor/pwa/offline.html'); // Serve custom offline page
    });
